...
public class APItems {
    ...
    public static final RegistryObject<Item> SUNMETAL_BLEND = ITEMS.register("sunmetal_blend", () -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
    public static final RegistryObject<Item> SUNMETAL_BRICK = ITEMS.register("sunmetal_brick", () -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
